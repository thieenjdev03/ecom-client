...
### Weight & Dimensions
✅ Backend accepts `weight` in `CreateProductDto`  
✅ Backend accepts `dimensions` object with `length`, `width`, `height`  
✅ `DimensionsDto` validates all numeric fields >= 0  
✅ Backend returns `weight` and `dimensions` in all product endpoints  
...
**Created:** 2025-11-11  
**Updated:** 2025-11-11 (added weight & dimensions)
